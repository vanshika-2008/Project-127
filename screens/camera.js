...
export default class PickImage extends React.Component{
    ...
    render(){
        ...
        return(
            ...
            <Button title = 'Pick image from camera roll' onPress = {this.pickImage}/>
    ...
    uploadImage = async() =>{
        ...
        fetch('',{method : 'POST',body : data, headers : {'content-type' : 'multipart/form-data'}})
